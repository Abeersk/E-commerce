    ...
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          {/* Flex Row for Single Row Layout */}
          <div className="flex justify-between gap-8">
            {featureData.map(({ Icon, title, description, adjustDescription }, index) => (
              <div
                key={index}
                className="p-6 bg-gray-100 hover:bg-gray-200 transition duration-300 rounded-lg shadow-lg w-1/4 flex flex-col justify-between"
              >
