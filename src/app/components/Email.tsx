...
const Email = () => {
  return (
    <div id='email' className="bg-gray-100 py-12">
      ...
      <section className="bg-white shadow-lg rounded-lg text-gray-600 body-font mx-auto w-[90%] max-w-[1350px] group hover:scale-110 transform transition duration-300 ease-in-out">
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="flex w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-center">
            <div className="relative flex-grow w-full text-center sm:flex-row flex-col sm:items-center">
              ...
              />
              <button className="text-white bg-indigo-500 border-0 focus:outline-none h-[54px] sm:w-32 w-full sm:rounded-r rounded-t mt-4 sm:mt-0 hover:bg-indigo-600 text-[12px]">
                Signup
              </button>
            </div>
          </div>
